...
open class Mesh {
	...
	private var mTextureBuffer // New variable.
			: FloatBuffer? = null

	// Our texture id.
	private var mTextureId = -1 // New variable.

	// The bitmap we want to load as a texture.
	private var mBitmap // New variable.
			: Bitmap? = null

	// Indicates if we need to load the texture.
	private var mShouldLoadTexture = false // New variable.
